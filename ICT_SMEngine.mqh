...
enum ENUM_SM_ZONE_SRC
  {
   SM_ZONE_CURRENT = 0,                            // A: market price at confirmation
   SM_ZONE_TRIG_PRIMARY, SM_ZONE_TRIG_SECONDARY,   // B: stage/slot zones
...
// ★ SINGLE SOURCE OF TRUTH: final trade direction (EntryMode overrides chain)
   ENUM_TRADE_DIRECTION tradeDir = SM_ResolveTradeDirection(*inst);
