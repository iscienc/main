//+------------------------------------------------------------------+
//|                        ICT_Unified_EA_v12.mq5                      |
//|              Professional Unified ICT Trading System              |
//|                         Version 12                               |
//+------------------------------------------------------------------+
#property copyright "ICT Unified Professional EA v12"
#property link      ""
...
int OnInit()
  {
   Print("===========================================================");
   Print("ICT Unified Professional EA v12 - Initializing...");
   Print("===========================================================");
...
// Keep this: SM detectors rely on OB/FVG/OTE data from this layer.
   ...
   Print("===========================================================");
   Print("ICT Unified EA v12 initialized successfully");
...
void OnDeinit(const int reason)
  {
   ...
   Print("ICT Unified EA v10 deinitialized. Reason: ", reason);
  }
