//+------------------------------------------------------------------+
//|                        ICT_Unified_EA_v14.mq5                      |
//|              Professional Unified ICT Trading System              |
//|                         Version 12                               |
//+------------------------------------------------------------------+
#property copyright "ICT Unified Professional EA v14"
#property link      ""
...
int OnInit()
  {
   Print("===========================================================");
   Print("ICT Unified Professional EA v14 - Initializing...");
   Print("===========================================================");
...
// Keep this: SM detectors rely on OB/FVG/OTE data from this layer.
   ...
   Print("===========================================================");
   Print("ICT Unified EA v14 initialized successfully");
...
void OnDeinit(const int reason)
  {
   ...
   Print("ICT Unified EA v14 deinitialized. Reason: ", reason);
  }
